...
const adminRoutes: AdminRouteDefinition[] = [
  ...
  { path: "/admin/stock-trading/market-data", title: "価格データ", description: "外部マーケットデータを収集し、ローソク足履歴を蓄積します。", element: <StockMarketDataPage /> },
  { path: "/admin/stock-trading/candidates", title: "AI候補銘柄", description: "Market Scanner が抽出した監視候補です。", element: <StockCandidatesPage /> },
  { path: "/admin/stock-trading/research", title: "リサーチ材料", description: "ニュース、決算、開示、ファンダ情報などAI判断に渡す材料です。", element: <StockResearchPage /> },
  { path: "/admin/stock-trading/signals", title: "市場シグナル", description: "TradingView webhook から受け取った紙取引用シグナルです。", element: <StockSignalsPage /> },
