# revenue-agent-api-security Specification

## Purpose

OpenClaw向けRevenueAgentPlatform APIをCloudflare本番公開に耐える境界として扱い、認証、rate limit、SSRF防止、副作用制御、secret sanitizationを保証する。
