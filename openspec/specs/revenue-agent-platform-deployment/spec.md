# revenue-agent-platform-deployment Specification

## Purpose

RevenueAgentPlatform を OpenClaw Gateway から本番利用できるように、HTTPS endpoint、Cloudflare protection、production secrets、side-effect-free verification、rollback contract を定義する。
