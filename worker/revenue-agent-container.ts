...
const DEFAULT_CONTAINER_SLEEP_AFTER = "3m";
...
const OPTIONAL_ENV = [
  ...
  "STOCK_MARKET_DATA_PROVIDER_KIND",
  "TWELVE_DATA_API_KEY",
  ...
  "REVENUE_AGENT_DISCOVERY_QUERIES",
  "REVENUE_AGENT_DISCOVERY_SEARCH_LIMIT",
  "REVENUE_AGENT_DISCOVERY_SEARCH_COUNTRY",
  "REVENUE_AGENT_DISCOVERY_SEARCH_LANG",
  "REVENUE_AGENT_DISCOVERY_SEARCH_LOCATION",
  "REVENUE_AGENT_DEFAULT_PAYMENT_AMOUNT_JPY",
  "OUTREACH_COOLDOWN_DAYS",
  "CONTACT_DISCOVERY_MAX_PAGES",
] as const;
